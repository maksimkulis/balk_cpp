...
ConcentratedPower::ConcentratedPower(int shift, double segment_length, double force)
    : Term(shift, segment_length, false)
    , force(force)
{
}
...
double Moment::calculate(double x, int degree) const {
    ...
    // if (degree) {
    //     return moment * power(x - shift * segment_length, 2) / factorial(2);
    // }
    // return moment * power(x - shift * segment_length, 1) / factorial(1);
}
...
double UniformLoad::calculate(double x, int degree) const {
    ...
    // if (degree) {
    //     return force * power(x - shift * segment_length, 4) / factorial(4);
    // }
    // return force * power(x - shift * segment_length, 3) / factorial(3);
}
